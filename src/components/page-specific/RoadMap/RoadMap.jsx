    ...
    <section className="pt-10 md:pt-40" id="roadmaps">
      <div className="container relative">
        <SectionHeader
          ...
          subtitle="Step-by-step guides to start learning effectively"
          btnShow={false}
        />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-7 mt-8">
          ...
          <div className="py-5 bg-gradient-to-r from-[#FF6F91] to-[#FFB535] overflow-hidden rounded-xl">
            <a
              href="https://sabzlearn.ir/course-cat/back-end/"
              className="flex flex-col justify-center items-center h-full"
          ...
          <div className="py-5 bg-gradient-to-r from-[#30C5E4] to-[#28E55D] overflow-hidden rounded-xl">
            <a
              href="https://sabzlearn.ir/course-cat/data-science/"
              className="flex flex-col justify-center items-center h-full"
              title="Data Science"
            >
              <svg
              ...
              >
                ...
                >
                  ...
                  >
                    <path
                      d="M0 3.8147e-06H48V48H0V3.8147e-06Z"
                      fill="white"
                    ></path>
                  </mask>
